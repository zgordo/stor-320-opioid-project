...
```{r, include=FALSE}
opioid_data_long = read_csv(file="C:/Users/mattb523/Documents/SCHOOL WORK/STOR320/FINAL PROJECT/Master_Table_Long.csv")
opioid_data_wide = read_csv(file="C:/Users/mattb523/Documents/SCHOOL WORK/STOR320/FINAL PROJECT/Wide_Master.csv")
...
county_voter_data = read_csv(file="C:/Users/mattb523/Documents/SCHOOL WORK/STOR320/FINAL PROJECT/countypres_2000-2016.csv")

county_voter_data <- county_voter_data %>%
  filter(year=="2016", office=="President") %>%
  select(year, state, county, party, candidatevotes, totalvotes) %>%
  filter(party!="NA") %>%
